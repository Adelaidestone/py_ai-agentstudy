...
public class ChatService {
    ...
    // ============ MiMo（小米 OpenAI 兼容协议）============
    public String mimoChat(String question) {
        return mimoClient.prompt().user(question).call().content();
    }

    public Flux<String> mimoChatStream(String question) {
        return mimoClient.prompt().user(question).stream().content();
    }
