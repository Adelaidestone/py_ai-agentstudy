...
| Day 2 | Milvus 部署 + Java SDK（本地无 Docker 走 Zilliz Cloud）| [📖 Day2](./Week3-向量库与Embedding/Day2-Milvus部署与上手.md) ｜ [📒 Zilliz接入实操](./笔记/ZillizCloud接入实操.md) |
...
│   ├── 向量数据库选型.md
│   ├── ZillizCloud接入实操.md         ← ⭐ 本地无 Docker 走云端 Milvus
│   ├── RAG调优技巧.md
